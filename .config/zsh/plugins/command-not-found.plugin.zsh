...
# |_____/_____|
#
# Provide suggested packages if a command cannot be found
# Source https://github.com/ohmyzsh/ohmyzsh/tree/608d62b2a5ee7f3af62dd8f31d47c167bf04547f/plugins/command-not-found
